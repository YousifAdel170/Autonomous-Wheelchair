...
float count_per_rev_lm = 50.0;// <======== set this number according to your motor (count per rev) for left motor

float count_per_rev_rm = 50.0;// <======== set this number according to your motor (count per rev) for right motor
...
double LM_kp = 3, LM_ki = 0 , LM_kd = 0.00000;          // modify for optimal performance
...
double RM_kp = 3, RM_ki = 0 , RM_kd = 0.00000;          // modify for optimal performance
